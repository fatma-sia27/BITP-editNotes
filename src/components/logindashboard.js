...
<button className="button mx-4" >2nd Year</button> <button className="button mx-4" >3rd Year</button>
</div></div>
   ...
   <div className="CS mx-5 my-2" style={{backgroundColor: "#5f9ea0", borderRadius: "7px"}}>
    <div className="row">
      ...
      <div className="col-6 mt-5" style={{fontFamily: "Cursive, sans-serif", fontSize: "20px",textTransform: "uppercase",
  letterSpacing: "1.0px", color: "#191970"}}>Electronice and Communications Engineering<div><button className="button mx-4">1st Year</button> 
